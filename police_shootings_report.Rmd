...
Plot 19 adds a geographical component and illustrates that the issue is ,despite variations, not regional but rather nation-wide. Readers will recognize that some states, especially in the west and southwest have high numbers ranging from 1.6 to 2.5 per 100.000 residents within two years. For those who are not so comfortable with geography I added the state names. Lastly, plot 20 shows that victims are often unarmed indicating that the police's use of force often may be excessive. Again there are some specifically alarming states including Minnesota, Iowa, Mississippi, and Maryland. Each has a unarmed rate over 15% and to be clear hear unarmed means no gun, play gun, knife, pipe, you name it, it means unarmed. 
</p> 
